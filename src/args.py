...
def get_parser():
    ...
    parser.add_argument('--loss_weight', nargs='+', type=float, default=[0.001, 1000.0, 1.0, 1.0, 1.0],
                        help='training loss weights. 1) quantity, 2) ingredient, 3) eos 4) cardinality 5) semantic') ## 원래는 1000.0, 1000.0, 1.0, 1.0
